export const allCars = [
    {
        ...
        category: "Sportive",
        description: "Une voiture sportive, confortable et idéale pour vos trajets en Suisse. 300 chevaux – moteur 2.0 TSI. Transmission intégrale 4Motion. Accélération 0–100 km/h en ~4.9s.",
        features: ["300 ch", "4Motion", "DSG", "0-100 km/h 4.9s", "Confort", "Performance"],
        location: "Lausanne",
    ...
    },
    {
        ...
        location: "Lausanne",
        dailyMileageLimit: 80,
        extraMileageCost: 3.50
    },
];
