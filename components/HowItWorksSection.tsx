                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {steps.map((step, index) => (
                        <motion.div
                            ...
                            className="bg-[#1a1f21] p-8 rounded-2xl border border-white/5 hover:border-primary/30 transition-all text-center group"
                        >
                            <div className="w-16 h-16 mx-auto mb-6 bg-gradient-to-br from-primary/20 to-primary/5 rounded-full flex items-center justify-center border border-primary/20 group-hover:scale-110 transition-transform">
